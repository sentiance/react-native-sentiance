...
@implementation RNSentiance (Converter)
...
- (NSString*)convertVenueType:(SENTVenueType)type {
    // TODO: provisional types are being exposed
    switch (type) {
        case SENTVenueTypeHome:
            return @"HOME";
        case SENTVenueTypeWork:
            return @"WORK";
        case SENTVenueTypePointOfInterest:
...
- (NSString*)convertTransportModeToString:(SENTTimelineTransportMode)mode {
    switch (mode) {
        case SENTTimelineTransportModeOnWalking:
            return @"WALKING";
        case SENTTimelineTransportModeOnRunning:
            return @"RUNNING";
