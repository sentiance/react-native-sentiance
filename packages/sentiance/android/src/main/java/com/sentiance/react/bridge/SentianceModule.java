...
import static com.sentiance.react.bridge.SentianceErrorCodes.E_SDK_CREATE_LINKED_USER_ERROR;
import static com.sentiance.react.bridge.SentianceErrorCodes.E_SDK_CREATE_UNLINKED_USER_ERROR;
import static com.sentiance.react.bridge.SentianceErrorCodes.E_SDK_GET_TOKEN_ERROR;
import static com.sentiance.react.bridge.SentianceErrorCodes.E_SDK_MISSING_PARAMS;
import static com.sentiance.react.bridge.SentianceErrorCodes.E_SDK_NOT_INITIALIZED;
import static com.sentiance.react.bridge.SentianceErrorCodes.E_SDK_RESET_ERROR;
import static com.sentiance.react.bridge.SentianceErrorCodes.E_SDK_START_TRIP_ERROR;
import static com.sentiance.react.bridge.SentianceErrorCodes.E_SDK_STOP_TRIP_ERROR;
import static com.sentiance.react.bridge.SentianceErrorCodes.E_SDK_SUBMIT_DETECTIONS_ERROR;
...
public class SentianceModule extends ReactContextBaseJavaModule implements LifecycleEventListener {
		...
		public void createLinkedUser(String appId, String secret, final Promise promise) {
				sentianceHelper.createLinkedUser(appId, secret)
								.addOnCompleteListener(new OnCompleteListener<UserCreationResult, UserCreationError>() {
										@Override
										public void onComplete(@NonNull PendingOperation<UserCreationResult, UserCreationError> pendingOperation) {
												if (pendingOperation.isSuccessful()) {
		...
		public void updateSdkNotification(final String title, final String message, Promise promise) {
				...
				Sentiance.getInstance(reactContext).updateSdkNotification(sentianceHelper.createNotificationFromManifestData(title, message));
				promise.resolve(true);
		}
