...
2. Go to `node_modules` ➜ `react-native-sentiance` and add `RNSentiance.xcodeproj`
3. In XCode, in the project navigator, select your project. Add `libRNSentiance.a` to your project's `Build Phases` ➜ `Link Binary With Libraries`
