...
const getUserContext = () => RNSentiance.getUserContext();
...
const listenVehicleCrashEvents = () => RNSentiance.listenVehicleCrashEvents();
const invokeDummyVehicleCrash = () => RNSentiance.invokeDummyVehicleCrash();
const isVehicleCrashDetectionSupported = () => RNSentiance.isVehicleCrashDetectionSupported();
const listenUserContextUpdates = () => RNSentiance.listenUserContextUpdates();
